...
from .LC_save_text import NODE_CLASS_MAPPINGS as _ST_MAP, NODE_DISPLAY_NAME_MAPPINGS as _ST_DISP
...
NODE_CLASS_MAPPINGS.update(_ST_MAP)
...
NODE_DISPLAY_NAME_MAPPINGS.update(_ST_DISP)
