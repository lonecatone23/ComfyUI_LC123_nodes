...
class LCLastImageHolder(PreviewImage):
    ...
    OUTPUT_NODE = True
    DESCRIPTION = (
        "Holds and displays the last generated image. "
        "Keeps the image even when input is disconnected. "
        "Clear button removes the store without re-running the workflow."
    )
