...
class LCWatermark(PreviewImage):
    ...
    OUTPUT_NODE = True
    DESCRIPTION = (
        "Watermark composite. Drag on the node preview to place; size/opacity update live. "
        "No watermark = bypass. Queue once to load previews, then adjust without wipe."
    )
